...
export class Backend implements backendInterface {
    ...
    async addLink(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async reorderLinks(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateLink(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
